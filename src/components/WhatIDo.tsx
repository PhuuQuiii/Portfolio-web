        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building scalable production systems — from CRM platforms and
                aviation tools to e-commerce and AI-assisted pipelines.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>ARCHITECT</h3>
              <h4>Database, DevOps & Design</h4>
              <p>
                Designing reliable infrastructure and intuitive interfaces —
                from database schemas to cloud deployments and UI prototypes.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
